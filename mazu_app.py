...
# ==============================
# UI 介面優化 Part 2：JavaScript 穿透 Shadow DOM 強制透明 (保留您原本的邏輯)
# ==============================
...
if xls:
    ...
    # ==============================
    # 🚨 關鍵：最後執行 JS 注入 (解決Shadow DOM不透明問題)
    # ==============================
    inject_shadow_css()
